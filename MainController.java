...
public class MainController extends BaseController {
    ...
    public String WelcomeUp(ModelMap modelMap, HttpServletResponse response, HttpServletRequest request) {
        Member member = ControllerUtils.getCurrentMember(request);
        modelMap.addAttribute("NAME",member.name);
        return "welcome";
    }
    @RequestMapping(method = RequestMethod.GET, value = "/user/HomePage")
    ...
    public  @ResponseBody String getTime(ModelMap modelMap,@RequestParam("country") String country, HttpServletRequest request) {
    ...
    public   String getTimehtml(ModelMap modelMap,@RequestParam("country") String country, HttpServletRequest request) {
        WikipediaDownloader wikipediaDownloader = new WikipediaDownloader(country);
        WikiResult x=  wikipediaDownloader.getResult();
        modelMap.addAttribute("IMAGE",x.getImageUrl());
    ...
    public
    @ResponseBody
    String handleSignUp(@RequestBody Member member, HttpServletRequest request, HttpServletResponse response) {
